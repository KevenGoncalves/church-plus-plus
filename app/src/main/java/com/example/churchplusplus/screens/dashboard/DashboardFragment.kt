...
import com.example.churchplusplus.Adapter.TuitionListAdapter
import com.example.churchplusplus.Adapter.Listeners.TuitionClickListener
...
import com.example.churchplusplus.databinding.FragmentDashboardBinding
...
class DashboardFragment : Fragment(), TuitionClickListener {
    ...
    override fun onCreateView(
        ...
        customName.setText(result.user.name)
        ...
        binding.textView12.setText(viewModel.getCountMembers(userId).toString())
