...
import com.example.churchplusplus.databinding.FragmentDefinicoesBinding
...
class DefinicoesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val cname = binding.churchNameInput5
        val loc = binding.locationInput2
        ...
        cname.setText(userData.name)
        loc.setText(userData.location)
        profile.setText(userData.user.name.substring(0,1))
        ctext.setText(userData.user.name)
        ...
        binding.button7.setOnClickListener{
            ...
            val church = Church(cname.text.toString(),loc.text.toString())

            val rs = viewModel.updateOne(userId,user,church)
